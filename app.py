"""
ИСПРАВЛЕННАЯ ВЕРСИЯ app.py для хостинга
Теперь на главной странице показывается сайт, а не JSON
"""
...
<body>
    ...
    <div class="status-indicator">🟢 Сервер онлайн</div>
    ...
    <script>
        ...
        async function loadReviews() {
            try {
                ...
                console.log('ℹ️ Ошибка загрузки отзывов');
            }
...
@app.route('/')
def index():
    """Главная страница - показываем HTML сайт"""
